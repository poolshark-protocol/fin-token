...
contract FIN is ERC20, Ownable, IXERC20 {
  /**
   ...
   */
  uint256 public constant MAX_SUPPLY = 20_000_000;
   ...
   *
   * @param _owner The owner which deployed this contract
   */
